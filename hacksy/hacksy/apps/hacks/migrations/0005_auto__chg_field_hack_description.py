...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hack.description'
        db.alter_column('hacks_hack', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Hack.description'
        raise RuntimeError("Cannot reverse this migration. 'Hack.description' and its values cannot be restored.")
