...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hack.pub_date'
        db.add_column('hacks_hack', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Hack.mod_date'
        db.add_column('hacks_hack', 'mod_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hack.pub_date'
        db.delete_column('hacks_hack', 'pub_date')

        # Deleting field 'Hack.mod_date'
        db.delete_column('hacks_hack', 'mod_date')
    ...
    models = {
        ...
        'hacks.hack': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'mod_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
