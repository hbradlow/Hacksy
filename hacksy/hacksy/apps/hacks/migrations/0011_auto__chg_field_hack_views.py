...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hack.views'
        db.alter_column('hacks_hack', 'views', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Hack.views'
        db.alter_column('hacks_hack', 'views', self.gf('django.db.models.fields.IntegerField')())
