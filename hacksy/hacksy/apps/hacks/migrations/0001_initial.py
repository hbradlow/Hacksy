...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hacks_hack', (
            ...
            ('code_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('demo_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('hacks', ['Hack'])


    def backwards(self, orm):
        # Deleting model 'Hack'
        db.delete_table('hacks_hack')
