...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hack.hackathon'
        db.add_column('hacks_hack', 'hackathon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hackathons.Hackathon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hack.hackathon'
        db.delete_column('hacks_hack', 'hackathon_id')
