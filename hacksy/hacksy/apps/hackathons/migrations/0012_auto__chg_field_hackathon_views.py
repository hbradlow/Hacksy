...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hackathon.views'
        db.alter_column('hackathons_hackathon', 'views', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Hackathon.views'
        db.alter_column('hackathons_hackathon', 'views', self.gf('django.db.models.fields.IntegerField')())
