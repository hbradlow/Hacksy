...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hackathon.location_notes'
        db.add_column('hackathons_hackathon', 'location_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hackathon.location_notes'
        db.delete_column('hackathons_hackathon', 'location_notes')
