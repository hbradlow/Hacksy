...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HackathonMember.name'
        db.alter_column('hackathons_hackathonmember', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'HackathonMember.name'
        db.alter_column('hackathons_hackathonmember', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
