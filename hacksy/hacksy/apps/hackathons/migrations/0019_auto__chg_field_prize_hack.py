...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prize.hack'
        db.alter_column('hackathons_prize', 'hack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hacks.Hack'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Prize.hack'
        raise RuntimeError("Cannot reverse this migration. 'Prize.hack' and its values cannot be restored.")
