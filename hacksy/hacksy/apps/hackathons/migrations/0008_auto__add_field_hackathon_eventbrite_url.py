...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hackathon.eventbrite_url'
        db.add_column('hackathons_hackathon', 'eventbrite_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hackathon.eventbrite_url'
        db.delete_column('hackathons_hackathon', 'eventbrite_url')
