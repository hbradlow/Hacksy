...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sponsors on 'Hackathon'
        db.create_table('hackathons_hackathon_sponsors', (
        ...
        db.create_unique('hackathons_hackathon_sponsors', ['hackathon_id', 'sponsor_id'])

        # Adding M2M table for field prizes on 'Hackathon'
        db.create_table('hackathons_hackathon_prizes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hackathon', models.ForeignKey(orm['hackathons.hackathon'], null=False)),
            ('prize', models.ForeignKey(orm['hackathons.prize'], null=False))
        ))
        db.create_unique('hackathons_hackathon_prizes', ['hackathon_id', 'prize_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sponsors on 'Hackathon'
        db.delete_table('hackathons_hackathon_sponsors')

        # Removing M2M table for field prizes on 'Hackathon'
        db.delete_table('hackathons_hackathon_prizes')
    ...
    models = {
        ...
        'hackathons.hackathon': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'prizes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['hackathons.Prize']", 'symmetrical': 'False'}),
